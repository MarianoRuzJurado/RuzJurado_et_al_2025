...
# Personally preference for scanpy's dotplot therefore convert to anndata for it and continue in scanyp_dotplot.py
...
# Save the test set
write.table(as.data.frame(dense.matrix), file = "/home/mariano/PycharmProjects/MLPGeneExpression/whole_matrix_Seurat_extract/test_set_only_n2_samples.csv", sep = ",", col.names = T, row.names = T)

write.csv(label_list, file = "/home/mariano/PycharmProjects/MLPGeneExpression/whole_matrix_Seurat_extract/test_set_only_n2_samples_labels.csv", row.names = FALSE)
```
