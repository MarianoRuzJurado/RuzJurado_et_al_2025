...
```{r}
# load object
Seu.Obj.annotated <- readRDS(file = "/mnt/mariano/Sequencing_Storage/scStorage/Mariano/Human_Mice_Comparison/Human_Mice_Integrated/Seurat_and_R_objects/SeuratObject.combined.integrated.annotated_10_08_22.rds")
...
#5. Extracting raw reads for scGPT
```{r}
Seu.Obj.annotated <- readRDS(file = "/mnt/mariano/Sequencing_Storage/scStorage/Mariano/Human_Mice_Comparison/Human_Mice_Integrated/Seurat_and_R_objects/SeuratObject.combined.integrated.annotated_10_08_22.rds")
DefaultAssay(object = Seu.Obj.annotated) <- "RNA"
...
meta.data <- Seu.Obj@meta.data
sparse.matrix <- Seu.Obj@assays$RNA@counts
dense.matrix <- as.matrix(sparse.matrix)
dense.matrix <- t(dense.matrix)
...
# Save the training set
write.table(as.data.frame(train_set), file = "/mnt/mariano/Sequencing_Storage/scStorage/Mariano/NN_Human_Mice/PaperExternRevision/250812_scGPT/objects/train_set_rawCounts_p_80.csv", sep = ",", col.names = T, row.names = T)


#Save test matrix Matrix
write.table(as.data.frame(val_set), file = "/mnt/mariano/Sequencing_Storage/scStorage/Mariano/NN_Human_Mice/PaperExternRevision/250812_scGPT/objects/val_set_rawCounts_p_20.csv", sep = ",", col.names = T, row.names = T)
...
write.csv(label_list.train, file = "/mnt/mariano/Sequencing_Storage/scStorage/Mariano/NN_Human_Mice/PaperExternRevision/250812_scGPT/objects/train_set_rawCounts_labels_p_80.csv", row.names = FALSE)
...
write.csv(label_list.val, file = "/mnt/mariano/Sequencing_Storage/scStorage/Mariano/NN_Human_Mice/PaperExternRevision/250812_scGPT/objects/val_set_rawCounts_labels_p_20.csv", row.names = FALSE)

```

## 5.1 Shuffle randomly Data tables (Good practice for better training)

```{r}
#Load the data sets
train_set <- read.delim(file = "/mnt/mariano/Sequencing_Storage/scStorage/Mariano/NN_Human_Mice/PaperExternRevision/250812_scGPT/objects/train_set_rawCounts_p_80.csv", header= TRUE, sep = ",")
val_set <- read.delim(file = "/mnt/mariano/Sequencing_Storage/scStorage/Mariano/NN_Human_Mice/PaperExternRevision/250812_scGPT/objects/val_set_rawCounts_p_20.csv", header= TRUE, sep = ",")

#Load the labels
train_labels <- read.delim(file = "/mnt/mariano/Sequencing_Storage/scStorage/Mariano/NN_Human_Mice/PaperExternRevision/250812_scGPT/objects/train_set_rawCounts_labels_p_80.csv", sep = ",")
val_labels <- read.delim(file = "/mnt/mariano/Sequencing_Storage/scStorage/Mariano/NN_Human_Mice/PaperExternRevision/250812_scGPT/objects/val_set_rawCounts_labels_p_20.csv", sep = ",")
...
#if everything is fine save as randomized sample set
write.table(shuffled_train_set, file = "/mnt/mariano/Sequencing_Storage/scStorage/Mariano/NN_Human_Mice/PaperExternRevision/250812_scGPT/objects/RANDOMIZED_train_set_rawCounts_p_80.csv", sep = ",", col.names = T, row.names = T)

write.csv(shuffled_train_labels, file = "/mnt/mariano/Sequencing_Storage/scStorage/Mariano/NN_Human_Mice/PaperExternRevision/250812_scGPT/objects/RANDOMIZED_train_set_rawCounts_labels_p_80.csv", row.names = FALSE)
...
#if everything is fine save as randomized sample set
write.table(shuffled_val_set, file = "/mnt/mariano/Sequencing_Storage/scStorage/Mariano/NN_Human_Mice/PaperExternRevision/250812_scGPT/objects/RANDOMIZED_val_set_rawCounts_p_20.csv", sep = ",", col.names = T, row.names = T)

write.csv(shuffled_val_labels, file = "/mnt/mariano/Sequencing_Storage/scStorage/Mariano/NN_Human_Mice/PaperExternRevision/250812_scGPT/objects/RANDOMIZED_val_set_rawCounts_labels_p_20.csv", row.names = FALSE)
```

##5.2 Extracting normalized expression data for machine learning training for test data
...
meta.data <- Seu.Obj.test@meta.data
sparse.matrix <- Seu.Obj.test@assays$RNA@counts
dense.matrix <- as.matrix(sparse.matrix)
dense.matrix <- t(dense.matrix)
...
# Save the test set
write.table(as.data.frame(dense.matrix), file = "/mnt/mariano/Sequencing_Storage/scStorage/Mariano/NN_Human_Mice/PaperExternRevision/250812_scGPT/objects/test_set_rawCounts.csv", sep = ",", col.names = T, row.names = T)

write.csv(label_list, file = "/mnt/mariano/Sequencing_Storage/scStorage/Mariano/NN_Human_Mice/PaperExternRevision/250812_scGPT/objects/test_set_rawCounts_labels.csv", row.names = FALSE)
```
